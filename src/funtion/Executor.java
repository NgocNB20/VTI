...
public class Executor {
    ...
    static AtomicReference<List<Integer>> numberV = new AtomicReference<List<Integer>>();
    ...
    public synchronized void read() throws InterruptedException {
        ...
        System.out.println("đã đọc file MỚI xong");
    ...
    public synchronized void write() throws InterruptedException {
        ...
        while (true) {
            ...
            System.out.println("length"+numberV.get().size());
